...
public class CaptureHelpers extends ScreenRecorder {
    ...
    public static void takeScreenshot(ITestResult result) {
        ...
        try {
            ...
            FileHandler.copy(source, new File(ConstantGlobal.SCREENSHOT_PATH + File.separator + result.getName() + ".png"));
    ...
    public static void takeScreenshot(String name) {
        ...
        try {
            ...
            FileHandler.copy(source, new File(ConstantGlobal.SCREENSHOT_PATH + File.separator + name + ".png"));
